package com.mad_assingment.practical11apidemo
...
import com.mad_assingment.practical11apidemo.api.RetofitInstance
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGet.setOnClickListener() {
            val call = RetofitInstance.api.getAll()
        ...
        btnLoad.setOnClickListener() {
            val call = RetofitInstance.api.getById("W001")
        ...
        btnAdd.setOnClickListener() {
            ...
            val call = RetofitInstance.api.add(id, name, programme, strImg)
